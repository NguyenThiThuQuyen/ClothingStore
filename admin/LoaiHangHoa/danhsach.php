            ...
            <div class="col-10">
                <div class="row">
                    <div class="col-12 mt-3">
                        ...
                        <h2 class="text-center mt-5">DANH SÁCH LOẠI HÀNG HÓA</h2>
                    </div>
                      ...
                      <div class="container">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="sua.php?MaLoaiHang=<?php echo $value['MaLoaiHang'] ?>" title="Sửa" class="text-dark"><i class="fas fa-pen mr-5"></i></a>                             
