<?php
    ...
    $data = mysqli_query($conn,"SELECT * FROM khachhang");
    $thanhtoan = mysqli_fetch_assoc($data);

    if(isset($_POST['HoTenKH'])){
        $HoTenKH = $_POST["HoTenKH"];
        $SoDienThoai = $_POST["SoDienThoai"];
        $sql = "UPDATE loaihanghoa SET HoTenKH = '$HoTenKH', SoDienThoai = '$SoDienThoai' WHERE MSKH = $MSKH";
...
<body>
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-md navbar-light navbar-bg">
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                      <a href="./basket.php" class="text-dark" style="text-decoration: none; font-size: 20px;"><i class="fas fa-shopping-cart fa-1x mr-3"></i>Giỏ hàng</a>
              </li>
                ...
                <div class="col-5" style="border: 1px solid">
                    ...
                    <form action="/booking" method="POST">
                        ...
                        <label for="HoTenKH" class="col-sm-3 col-form-label form_label">Họ Tên</label>
                            <div class="col-sm-11">
                                <input type="text" class="form-control" name="HoTenKH" id="HoTenKH" value="<?php echo $_SESSION['HoTenKH'] ?>">
                            </div>
                        </div>
                        <div class="form-group row mt-5 mx-auto">
                        <label for="SoDienThoai" class="col-sm-3 col-form-label form_label">Số điện thoại</label>
                            <div class="col-sm-11">
                                <input type="text" class="form-control" name="SoDienThoai" id="SoDienThoai" value="<?php echo $thanhtoan['SoDienThoai'] ?>">
                            </div>
                        </div>
                        <div class="form-group row mt-5 mx-auto">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <button type="button" class="btn btn-outline btn-lg navbar-bg btn-light mt-5">
                                    <a href="thanhtoan.php" class="text-dark" style="text-decoration: none;"><i class="fas fa-check mr-3"></i>THANH TOÁN</a>
                            </button>
                            </div>
                        </div>
